        ...
        <div class="content">
            ...
            <div class="dashboard-content px-3 py-4">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="table-responsive" style="width: 100%;">
                                <table class="table table-striped">
                                    ...
                                    $query = "SELECT * FROM complaint_table WHERE sender_ID = '$residentID'  ORDER BY complaint_ID DESC LIMIT $start, 10;";
                                    $result = $conn -> query($query);
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link text-dark" href="view_complaints.php?page=<?php echo $previous;?>">Previous</a></li>
                        <?php for($i=1; $i<=$pages;$i++)
                        {?>
                            <li class="page-item"><a class="page-link text-dark" href="view_complaints.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
                        <?php 
                        }?>
                        <li class="page-item"><a class="page-link text-dark" href="view_complaints.php?page=<?php echo $next;?>">Next</a></li>
                    </ul>
                </nav>
            </div>
        </div>
