					...
					<div class="modal-content">
					  ...
					  <form name="chnguser" method="post" action="edit_number.php">
						  <div class="modal-body">
							  ...
							  <input name="contactnumber" type="number" maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/gi, '').replace(/(\..*)\./gi, '$1')" class="form-control" value="<?php echo $row["contactnumber"]; ?>" >
						  </div>
						  <div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
