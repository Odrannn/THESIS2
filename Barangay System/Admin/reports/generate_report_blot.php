...
{
$comp_query1 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'settled' AND blotter_date = '$currentDate';";
$comp_result1 = $conn -> query($comp_query1);
$comp_row1 = $comp_result1 -> fetch_array();
$settled = $comp_row1[0];
//count pending                    
$comp_query2 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unsettled' AND blotter_date = '$currentDate';";
$comp_result2 = $conn -> query($comp_query2);
$comp_row2 = $comp_result2 -> fetch_array();
$unsettled = $comp_row2[0];

//count nature[1]                   
$comp_query3 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'scheduled' AND blotter_date = '$currentDate';";
$comp_result3 = $conn -> query($comp_query3);
$comp_row3 = $comp_result3 -> fetch_array();
$scheduled = $comp_row3[0];

//count nature[2]                   
$comp_query4 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unscheduled' AND blotter_date = '$currentDate';";
...
$unscheduled = $comp_row4[0];
	...
	$html .="
			...
			<body>	
				<h1>DAILY BLOTTER REPORT<BR> $currentDate</h1>
				...
				$query10 = "SELECT * FROM blotter_table WHERE blotter_date = $currentDate;";
...
{
//count solved
$comp_query1 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'settled' AND MONTH(blotter_date) = MONTH(now());";
$comp_result1 = $conn -> query($comp_query1);
$comp_row1 = $comp_result1 -> fetch_array();
$settled = $comp_row1[0];
//count pending                    
$comp_query2 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unsettled' AND MONTH(blotter_date) = MONTH(now());";
$comp_result2 = $conn -> query($comp_query2);
$comp_row2 = $comp_result2 -> fetch_array();
$unsettled = $comp_row2[0];

//count nature[1]                   
$comp_query3 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'scheduled' AND MONTH(blotter_date) = MONTH(now());";
$comp_result3 = $conn -> query($comp_query3);
$comp_row3 = $comp_result3 -> fetch_array();
$scheduled = $comp_row3[0];

//count nature[2]                   
$comp_query4 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unscheduled 'AND MONTH(blotter_date) = MONTH(now());"; 
$comp_result4 = $conn -> query($comp_query4);
$comp_row4 = $comp_result4 -> fetch_array();
$unscheduled = $comp_row4[0];
    ...
    $html .= '<hr style="margin: 0 40px;">';
		...
		$html .="
			...
			<body>	
				<h1>MONTHLY BLOTTER REPORT - $month</h1>
				<table class='table table-bordered' align='center' width='100%'>
				  <thead>
					<tr>
					  <th colspan='2'>OVERALL</th>
				...
				$query10 = "SELECT * FROM blotter_table WHERE month(blotter_date) = month(now());";
				$result10 = $conn -> query($query10);
...
{
//count solved
$comp_query1 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'settled' AND year(blotter_date) = year(now());";
$comp_result1 = $conn -> query($comp_query1);
$comp_row1 = $comp_result1 -> fetch_array();
$settled = $comp_row1[0];
//count pending                    
$comp_query2 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unsettled' AND year(blotter_date) = year(now());";
$comp_result2 = $conn -> query($comp_query2);
$comp_row2 = $comp_result2 -> fetch_array();
$unsettled = $comp_row2[0];

//count nature[1]                   
$comp_query3 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'scheduled' AND year(blotter_date) = year(now());";
$comp_result3 = $conn -> query($comp_query3);
$comp_row3 = $comp_result3 -> fetch_array();
$scheduled = $comp_row3[0];

//count nature[2]                   
$comp_query4 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unscheduled' AND year(blotter_date) = year(now());";
$comp_result4 = $conn -> query($comp_query4);
$comp_row4 = $comp_result4 -> fetch_array();
$unscheduled = $comp_row4[0];
    ...
    $html .= '<hr style="margin: 0 40px;">';
		...
		$html .="
			...
			<body>	
				<h1>YEARLY BLOTTER REPORT - $year</h1>
				<table class='table table-bordered' align='center' width='100%'>
				  <thead>
					<tr>
					  <th colspan='2'>OVERALL</th>
				...
				$query10 = "SELECT * FROM blotter_table WHERE year(blotter_date) = year(now());";
				$result10 = $conn -> query($query10);
...
{
//count solved
$comp_query1 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'settled';";
$comp_result1 = $conn -> query($comp_query1);
$comp_row1 = $comp_result1 -> fetch_array();
$settled = $comp_row1[0];
//count pending                    
$comp_query2 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unsettled';";
$comp_result2 = $conn -> query($comp_query2);
$comp_row2 = $comp_result2 -> fetch_array();
$unsettled = $comp_row2[0];

//count nature[1]                   
$comp_query3 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'scheduled';";
$comp_result3 = $conn -> query($comp_query3);
$comp_row3 = $comp_result3 -> fetch_array();
$scheduled = $comp_row3[0];

//count nature[2]                   
$comp_query4 = "SELECT COUNT(complainant_ID) FROM blotter_table WHERE status = 'unscheduled';";
$comp_result4 = $conn -> query($comp_query4);
$comp_row4 = $comp_result4 -> fetch_array();
$unscheduled = $comp_row4[0];
	...
	$html .="
			...
			<body>	
				...
				$query10 = "SELECT * FROM blotter_table;";
				$result10 = $conn -> query($query10);
