...
<body>
    <div class="main_container d-flex">
        ...
        ?>">
            ...
            <li class="active"><a href="../case_management.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-paper-plane"></i>&nbsp;Case</a></li>
            ...
            <div class="dashboard-content px-3 py-4">
                ...
                <div class="d-flex justify-content-center">
                    <div class="btn-group">
                        ...
                        <a href="#" class="btn btn-dark">Suggestion</a>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <form action="../add_option.php" method="post">
                                <td><input class="form-control" type="text" name= "suggestion" oninput="this.value = this.value.replace(/[^a-z ]/gi, '').replace(/(\..*)\./gi, '$1')" placeholder="enter nature...">
