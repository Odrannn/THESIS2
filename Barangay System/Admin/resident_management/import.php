...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"]>0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            $sqlInsert = "INSERT INTO tblresident(id,user_id,fname,mname,lname,suffix,gender,birthplace,civilstatus,birthday,age,household_ID,unitnumber,purok,sitio,street,subdivision,contactnumber,email,religion,occupation,education,nationality,disability,status)
