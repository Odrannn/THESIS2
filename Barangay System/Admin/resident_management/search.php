...
$sql = "SELECT * FROM resident_table WHERE fname LIKE '%".$_POST['name']."%' OR mname LIKE '%".$_POST['name']."%' OR lname LIKE '%".$_POST['name']."%' OR id LIKE '%".$_POST['name']."%' OR status LIKE '%".$_POST['name']."%' OR contactnumber LIKE '%".$_POST['name']."%' OR gender LIKE '%".$_POST['name']."%' OR civilstatus LIKE '%".$_POST['name']."%'";
