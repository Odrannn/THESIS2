        ...
        <div class="modal-body" style="height: 50%;overflow-y: auto;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md pt-2">
                        <div class="form-floating">
                            <input class="form-control" type="text" id="occupation" name="occupation" placeholder="Occupation" onkeyup="lettersOnly(this)" required>
                    ...
                    <div class="col-md pt-2">
                        <div class="form-floating">
                            <input class="form-control" type="text" id="disability" name="disability" placeholder="Disability" onkeyup="lettersOnly(this)" required>
                            <p><small class="p-2">leave it blank if none.</small></p>
