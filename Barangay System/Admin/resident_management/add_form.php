        ...
        <div class="modal-body" style="height: 50%;overflow-y: auto;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md pt-2">
                        <div class="form-floating">
                            <input class="form-control" type="text" id="unitnumber" name="unitnumber" placeholder="Unit Number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md pt-2">
                        <div class="form-floating">
                            <input class="form-control" type="text" id="contactnumber" name="contactnumber" placeholder="09..." maxlength="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                ...
                <div class="row">
                    <div class="col-md pt-2">
                        <div class="form-floating">
                            <input class="form-control" type="text" id="occupation" name="occupation" placeholder="Occupation" oninput="this.value = this.value.replace(/[^a-z]/gi, '').replace(/(\..*)\./gi, '$1')" required>
                    ...
                    <div class="col-md pt-2">
                        <div class="form-floating">
                            <input class="form-control" type="text" id="disability" name="disability" placeholder="Disability" oninput="this.value = this.value.replace(/[^a-z]/gi, '').replace(/(\..*)\./gi, '$1')" required>
                            <p><small class="p-2">leave it blank if none.</small></p>
