...
<body>
    <div class="main_container d-flex">
        ...
        ?>">
            ...
            <li class=""><a href="../Healthcare_Admin/healthcare_center/healthcare_center.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-gauge"></i>&nbsp;Manage Healthcare</a></li>
            </ul>
        </div>
        ...
        <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="profile.php"><i class="fa-solid fa-user px-2"></i>Profile</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="dashboard-content px-3 py-4">
                <a href="../Healthcare_Admin/healthcare_center/healthcare_center.php"><button type="button" class="btn btn-dark">Back</button></a>
                <br>
                <br>
